...
WARNING, I completed this assignment, I went on both copies of the game and moved the pieces around but I got an error message trying to push the it back to the repository so just in case know that I did do it.
